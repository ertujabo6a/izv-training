...
def test_generate_sin():
    ...
    training.generate_sinus(show_figure=False, save_path="tmp_sin.png")
    assert os.path.exists("tmp_sin.png")


def test_download():
    "Test data download"
    data = training.download_data()
